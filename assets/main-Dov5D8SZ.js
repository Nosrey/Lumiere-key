import{r as u,a as v}from"./Footer-DNQXhcrP.js";function b(e){try{document.body.classList.add("page-home")}catch{}e.innerHTML=`
...
`;const s=document.querySelector("#app");s&&s.parentNode?document.body.insertBefore(a,s):document.body.appendChild(a);try{const e=new Image;e.src=d,e.onload=()=>{try{a.style.setProperty("--hero-bg",`url('${d}')`),a.classList.add("hero--gif-ready")}catch{}}}catch{}const c=document.querySelector("#app");c&&b(c);const n=document.createElement("section");n.className="areas-section";n.innerHTML=`
