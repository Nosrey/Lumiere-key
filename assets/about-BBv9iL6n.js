import{r as d,a as m}from"./Footer-DMdW5SUs.js";/* empty css              */const u="/Lumiere-key/assets/image-1-CccbALsx.jpeg",l="/Lumiere-key/assets/image-2-BhAbLFGZ.jpeg",p="/Lumiere-key/assets/image-3-BIMkz29N.jpeg",b="/Lumiere-key/assets/image-3-BIMkz29N.jpeg";function v(e,c=!1){e.innerHTML="";const a=document.createElement("section");a.className="comprar-hero",a.style.backgroundImage=`url('${u}')`,a.id="about-hero",a.innerHTML=`
  ...
  `;const i=document.createElement("section");i.className="comprar-body",i.style.backgroundImage=`url('${l}')`;const n=document.createElement("div");n.className="container comprar-body-inner about-content";const o=document.createElement("div");o.className="comprar-content-inner text-justify",o.innerHTML=`
    ...
    <section class="about-team-grid">
      <div class="team-member">
        ...
        <div class="member-image">
          <img src="${p}" alt="Kevin - Co-fundador" loading="lazy"/>
        </div>
      ...
      <div class="team-member">
        <h3>Luz</h3>
        <div class="member-image">
          <img src="${b}" alt="Luz - Co-fundadora" loading="lazy"/>
        </div>
        <div class="member-description">
  ...
  `,n.appendChild(o),i.appendChild(n),c&&e.parentNode?e.parentNode.insertBefore(a,e):e.appendChild(a),e.appendChild(i)}const r=document.createElement("div");r.id="navbar-container";document.body.insertBefore(r,document.body.firstChild);d(r);const t=document.getElementById("app");t&&v(t,!0);const s=document.createElement("div");s.id="footer-container";document.body.appendChild(s);m(s);
